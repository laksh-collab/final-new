...
const productsPresetVersionKey = "mumma-lookbook-products-gallery-version";
const productsPresetVersion = "20260715-explicit-32-product-media";
...
const bundledProductMedia = Object.fromEntries(
  Array.from({ length: 32 }, (_, index) => {
    const name = `product-${String(index + 1).padStart(2, "0")}`;
    return [name, { src: `media/${name}.jpeg`, type: "image" }];
  })
);

const defaultProductSeeds = [
  { title: "DRESS", media: { front: "product-01" } },
  { title: "DRESS", media: { front: "product-02" } },
  { title: "DRESS", media: { front: "product-03" } },
  { title: "DRESS", media: { front: "product-04" } },
  { title: "DRESS", media: { front: "product-05" } },
  { title: "DRESS", media: { front: "product-06" } },
  { title: "DRESS", media: { front: "product-07" } },
  { title: "DRESS", media: { front: "product-08" } },
  { title: "DRESS", media: { front: "product-09" } },
  { title: "DRESS", media: { front: "product-10" } },
  { title: "DRESS", media: { front: "product-11" } },
  { title: "DRESS", media: { front: "product-12" } },
  { title: "DRESS", media: { front: "product-13" } },
  { title: "DRESS", media: { front: "product-14" } },
  { title: "DRESS", media: { front: "product-15" } },
  { title: "DRESS", media: { front: "product-16" } },
  { title: "DRESS", media: { front: "product-17" } },
  { title: "DRESS", media: { front: "product-18" } },
  { title: "DRESS", media: { front: "product-19" } },
  { title: "DRESS", media: { front: "product-20" } },
  { title: "DRESS", media: { front: "product-21" } },
  { title: "DRESS", media: { front: "product-22" } },
  { title: "BLOUSE", media: { front: "product-23" } },
  { title: "TOP", media: { front: "product-24" } },
  { title: "TOP", media: { front: "product-25" } },
  { title: "BLOUSE", media: { front: "product-26" } },
  { title: "TOP", media: { front: "product-27" } },
  { title: "BLOUSE", media: { front: "product-28" } },
  { title: "TOP", media: { front: "product-29" } },
  { title: "DRESS", media: { front: "product-30" } },
  { title: "TOP", media: { front: "product-31" } },
  { title: "TOP", media: { front: "product-32" } },
];
...
const loadProducts = () => {
  try {
    const storedVersion = window.localStorage.getItem(productsPresetVersionKey);
    const stored = JSON.parse(window.localStorage.getItem(productsStorageKey) || "[]");

    if (storedVersion !== productsPresetVersion) {
...
const saveProducts = () => {
  window.localStorage.setItem(productsPresetVersionKey, productsPresetVersion);
